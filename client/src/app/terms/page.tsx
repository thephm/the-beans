...
export default function TermsPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 dark:bg-none pt-24 pb-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg dark:shadow-xl border border-gray-200 dark:border-gray-700 p-8">
          <div className="mb-12">
