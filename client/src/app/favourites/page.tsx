    ...
    <main className="min-h-screen bg-gradient-to-br from-lavender-50 via-white to-orchid-50 dark:bg-gray-950 dark:bg-none">
      <section className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="pt-24 pb-16">
          ...
          {!hasFavourites ? (
            <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-lg p-8 text-center border-t-4 border-gray-200 dark:border dark:border-gray-700 max-w-2xl mx-auto">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">{t('favourites.noFavouritesYet')}</h3>
